import string.ascii_lowercase as lowercase
import string.ascii_uppercase as uppercase
import string.letters as letters
import re
...
@lang.rule('int', regex(r'\d+'), hints=digits)
